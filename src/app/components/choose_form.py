...
projections_from_form = html.Div(children=[projections_from_label, projections_from_input, projections_from_value], className="row-between")
...
projections_to_form = html.Div(children=[projections_to_label, projections_to_input, projections_to_value], className="row-between")
